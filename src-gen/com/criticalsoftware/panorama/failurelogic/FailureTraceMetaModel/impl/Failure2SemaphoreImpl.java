 ...
 * </p>
 * <ul>
 *   <li>{@link com.criticalsoftware.panorama.failurelogic.FailureTraceMetaModel.impl.Failure2SemaphoreImpl#getFailure <em>Failure</em>}</li>
...
public class Failure2SemaphoreImpl extends SafetyTraceabilityImpl implements Failure2Semaphore {
		...
		if (failure != null && failure.eIsProxy()) {
			...
			if (failure != oldFailure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FailureTraceMetaModelPackage.FAILURE2_SEMAPHORE__FAILURE, oldFailure, failure));
			}
		}
		return failure;
	}
	...
	public void setFailure(Failure newFailure) {
		...
		failure = newFailure;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FailureTraceMetaModelPackage.FAILURE2_SEMAPHORE__FAILURE, oldFailure, failure));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FailureTraceMetaModelPackage.FAILURE2_SEMAPHORE__FAILURE:
