...
public class FailureTraceMetaModelPackageImpl extends EPackageImpl implements FailureTraceMetaModelPackage {
	 ...
	 * @generated
	 */
	public EAttribute getPropagateTo_Failure() {
		return (EAttribute)propagateToEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Process_Failure() {
	...
	public EReference getFailure2Process_Process() {
		return (EReference)failure2ProcessEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Runnable_Failure() {
	...
	public EReference getFailure2Runnable_Runnable() {
		return (EReference)failure2RunnableEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Event_Failure() {
	...
	public EReference getFailure2Event_Event() {
		return (EReference)failure2EventEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Semaphore_Failure() {
	...
	public EReference getFailure2Semaphore_Semaphore() {
		return (EReference)failure2SemaphoreEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Label_Failure() {
	...
	public EReference getFailure2Label_Label() {
		return (EReference)failure2LabelEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Constraint_Failure() {
	...
	public EReference getFailure2Constraint_Constraint() {
		return (EReference)failure2ConstraintEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFailure2Component_Failure() {
	...
	public EReference getFailure2Component_Component() {
		return (EReference)failure2ComponentEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(failure2ComponentEClass, FAILURE2_COMPONENT__FAILURE);
	...
	public void initializePackageContents() {
		...
		failureTraceModelEClass.getESuperTypes().add(theTracemodelPackage.getGenericTraceModel());
		propagateToEClass.getESuperTypes().add(theTracemodelPackage.getRelatedTo());
		...
		initEAttribute(getPropagateTo_Failure(), theEcorePackage.getEString(), "failure", null, 0, 1, PropagateTo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Process_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Runnable_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Runnable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Event_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Semaphore_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Semaphore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Label_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Label.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Constraint_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure2Component_Failure(), theFailureLogicPackage.getFailure(), null, "failure", null, 1, 1, Failure2Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
